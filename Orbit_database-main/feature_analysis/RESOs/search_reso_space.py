...
if __name__ == "__main__":
    ...
    parser.add_argument("--p", type=float, default=10.0, help="Resonance parameter p.")
    parser.add_argument("--q", type=float, default=1.0, help="Resonance parameter q.")
    parser.add_argument("--retro", type=bool, default=True, help="Specifies if resonant orbit is retrograde")
    parser.add_argument("--start", type=float, default=0.69, help="Start value for x positions.")
    parser.add_argument("--p", type=float, default=10.0, help="Resonance parameter p.")
    parser.add_argument("--q", type=float, default=3.0, help="Resonance parameter q.")
    ...
    parser.add_argument("--stop", type=float, default=0.99, help="Stop value for x positions.")
    ...
    filename = f"{data_path}reso_orbits_{args.p}_{args.q}_retro{args.retro}.pkl"

    # Define the range of initial x positions
    start = args.start
    stop = args.stop
    step = 0.02
    x_starts = np.arange(start, stop + step, step)
